...
from execute_code import execute_python_file, execute_terminal_command
...
def execute_command(command_name, arguments):
    ...
    try:
        ...
        elif command_name == "execute_terminal_command":
            return execute_terminal_command(arguments["command"])
